...
selected_season1 = st.sidebar.selectbox("Season (First Player):",['All','2022-2023',"2023-2024",'2024-2025'],index=4)
...
selected_season2 = st.sidebar.selectbox("Season (Second Player):",['All','2022-2023',"2023-2024",'2024-2025'],index=4)
