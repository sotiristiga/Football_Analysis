...
selected_season = st.sidebar.selectbox("Season:",['All','2022-2023','2023-2024','2024-2025'],index=0)
...
basic,attack,defence,duels,passing,goalkeeping=st.tabs(['Basic Stats','Attack Stats','Defence Stats','Duels Stats','Passing Stats','Goalkeeping Stats'])
