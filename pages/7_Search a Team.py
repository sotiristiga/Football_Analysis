...
if "All" in selected_season:
    selected_season = ['2016-2017', '2017-2018', '2018-2019', '2019-2020', '2020-2021', '2021-2022', '2022-2023',
                       '2023-2024', '2024-2025']
...
Superstats,playersstats,statsgame=st.tabs(['Superleague Stats','Players Stats','Stats by game'])
with Superstats:
        ...
        with allstats:
            ...
            with selectstat:
                statselectors = st.selectbox("Select Stat:",
                                             ['Goals', 'Assists', 'Yellow card', 'Red card', 'Shots', 'Dribble',
